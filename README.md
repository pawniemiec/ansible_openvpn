# ansible_openvpn
=========
All credits go to Kyle Lexmond:
...
| openvpn_server_network             | string  |              | 10.0.0.0                                       | Private network used by OpenVPN service                                                                                                                           |
| openvpn_server_netmask             | string  |              | 255.255.0.0                                  | Netmask of the private network                                                                                                                                    |
